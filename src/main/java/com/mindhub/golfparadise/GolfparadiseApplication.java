...
public class GolfparadiseApplication {
	...
	public CommandLineRunner initData(ClientRepository clientRepository,
		...
		return (args) -> {
			...
			OrderPurchase order1 = new OrderPurchase(2000.00,"Cll Central 234", 19.90, LocalDateTime.now());
...
//			Product product1 = new Product("Deep Red Tour Complete Set", "The Callaway XR Packaged Golf Set is packed with ball speed technologies to deliver long distance and complete course coverage through the bag.", "https://www.wilson.com/en-us/media/catalog/product/W/G/WGGC69600__bbbf0d8c83b04373bfe986c054c23576.png?dpr=1&fit=bounds&orient=1&quality=95&optimize=high&format=pjpg&auto=webp&enable=upscale&width=762&height=932&canvas=762%2C932&bg-color=f5f5f5", 1399.99, 5, Category.CLUBS);
			...
			Product product10 = new Product("Women Launcher XL Lite Driver", "A Driver designed to fit your game just makes more sense, doesn’t it? Shorter shafts, retooled shaft flex, and an upgraded grip make the Women’s Launcher XL Lite Driver the perfect fit.", "https://us.dunlopsports.com/on/demandware.static/-/Sites-masterCatalog_DunlopSports/default/dw7bcff770/images/large/CG22-Clubs-Launcher-XL-Driver-Lite-Womens-2.jpeg", 500.00, 12, Category.CLUBS);

			Product product11 = new Product("Honma Caddie Bags CB12213", "Lightweight basic caddie bag with upgraded side pocket functions.", "https://honmagolf.com/storage/product/9090_CB12213_NY_600x600.jpg", 320.00, 10, Category.BAGS);
			Product product12 = new Product("Honma Caddie Bags CB122203", "2022 Pro Tour Replica caddie bag, developed with HONMA Tour Pro golfers.", "https://honmagolf.com/storage/product/9084_CB12203_BK_hood.jpg", 380.00, 5, Category.BAGS);
			Product product13 = new Product("Honma Caddie Bags CB12211", "Lightweight basic caddie bag with upgraded side pocket functions", "https://honmagolf.com/storage/product/9010_CB12211_WH_RED_600x600.jpg", 390.00, 10, Category.BAGS);
			Product product14 = new Product("Honma Caddie Bags CB12209", "Sporty design caddie bag with an accent on the side panels by using the two different glossy materials.", "https://honmagolf.com/storage/product/9008_CB12209_WH_NY%5b1%5d.jpg", 380.00, 12, Category.BAGS);
			Product product15 = new Product("Honma Caddie Bags CB12201", "2022 Pro Tour caddie bag, developed with HONMA Tour Pro golfers. High spec model with excellent functions such as high durability, waterproof fasteners, and cushion pads.", "https://honmagolf.com/storage/product/9004_CB12201_NY.jpg", 370.00, 5, Category.BAGS);
			Product product16 = new Product("Honma Caddie Bags CB12115", "Lightweight caddy bag designed in HONMA D1 ball fluorescent colors with DANCING HONMA logo.", "https://honmagolf.com/storage/product/8120_CB12115_GRAY.jpg", 380.00, 12, Category.BAGS);
			Product product17 = new Product("Honma Caddie Bags CB12114", "POLYESTER | SYNTHETIC LEATHERS (P.V.C) Lightweight caddy bag designed in HONMA D1 ball fluorescent colors with DANCING HONMA logo.", "https://honmagolf.com/storage/product/8116_CB12114_ORANGE.jpg", 360.00, 10, Category.BAGS);
			Product product18 = new Product("Honma Caddie Bags CB12113", "POLYESTER | SYNTHETIC LEATHER (P.V.C）Color BLACK | GRAY | NAVY | WHITE", "https://honmagolf.com/storage/product/8114_CB12113_BLACK.jpg", 350.00, 10, Category.BAGS);
			Product product19 = new Product("Honma Caddie Bags CB12102", "This stylish, high-strength caddy bag features waterproof zippers and high strength core material.", "https://honmagolf.com/storage/product/8084_CB12102_RED.jpg", 400.00, 5, Category.BAGS);
			Product product20 = new Product("Honma Pro Stand Bag CB12002", "This 2020 Tournament Spec professional stand bag is fully equipped water repellent zipper and all the functionailty of a staff bag in stand bag frame", "https://honmagolf.com/storage/product/5990_CB12002_SAX_NY.jpg", 340.00,10, Category.BAGS);

			Product product21 = new Product("Honma Golf Balls 2020 model", "The No.1 best-selling ball* has evolved under the concept of “More Distance”. The newly compounded soft rubber core boosts the distance performance while maintaining beautiful feeling.", "https://honmagolf.com/storage/product/8624_7816_1_white.jpg", 90.00, 5, Category.BALLS);
			Product product22 = new Product("Honma Golf Balls X4", "Structure: 4-piece Color: White/Yellow Cover: Urethane Cover Core: Ultra Soft Core Dimple: 326 Dimples", "https://honmagolf.com/storage/product/5842_X4_1.jpg", 80.00, 10, Category.BALLS);
			Product product23 = new Product("Honma Golf Balls TW-S", "Structure: 3-piece Color: White/Yellow Cover: Urethane Cover Core: S-Fast Core Dimple: 326 Dimples", "https://honmagolf.com/storage/product/5840_1106131452_5dc248bcac482.jpg", 85.00, 5, Category.BALLS);
			Product product24 = new Product("Honma Golf Balls TW-X", "Structure: 3-piece Color: White/Yellow Cover: Urethane Cover Core: Super Fast NC Core Dimple: 326 Dimples", "https://honmagolf.com/storage/product/5838_1106130114_5dc2458abc01e.jpg", 80.00, 8, Category.BALLS);
			Product product25 = new Product("Honma Golf Balls Honma A1", "Structure: 2-piece  Color: White/Yellow/Orange/Muti-color (White, Yellow, Orange, Pink)  Cover: Ionomer Cover Core: Newly Developed Super Soft Core Dimple: 368 Dimples", "https://honmagolf.com/storage/product/5836_A1.jpg", 80.00, 10, Category.BALLS);
			Product product26 = new Product("Honma Golf Balls D1 Plus", "Structure: 3-piece ball Color: White/Multi-color (White/Yellow/Orange/Pink) Cover: Ionomer cover Core: High-resilience spring rubber core Dimple: 368 dimples", "https://honmagolf.com/storage/product/5192_Honmagolf_ball_D1plus.jpg", 82.00, 10, Category.BALLS);
			Product product27 = new Product("Honma Golf Balls Future XX", "Structure: 6-piece  Cover :  Soft polyurethane Layer 2: Highly resilient ionic polymer layer Layer 3: High-rebound layer Layer 4 : Intermediate soft layer Layer 5 : Soft layer Core: Soft rubber core Dimple : 326", "https://honmagolf.com/storage/product/5186_honmagolf_ball_futurexx1.jpg",70.00, 8, Category.BALLS);
			...
			Product product34 = new Product("A1 NANO Gloves GV12003", "This all-weather glove, perfect in rain or sunny conditions, is constructed of unique Nanofront® material for increased action in wet conditions.", "https://honmagolf.com/storage/product/6024_GV12003_img.jpg",20.00,6,Category.CLOTHES);
			Product product35 = new Product("P1 Gloves GV12002", "The P1 glove is the choice of touring professionals. Constructed from Japanese man-made leather (Clarino),  features two different materials on the palm and back of the hand.", "https://honmagolf.com/storage/product/6022_GV12002_img.jpg",22.00, 12, Category.CLOTHES);
			Product product36 = new Product("Honma Gloves GA-1902", "Material Artificial Leather Color White Weight\t15g Size 21~26cm Origin Indonesia", "https://honmagolf.com/storage/product/5416_HONMA%20GLOVES%20GA1902_WH_2.jpg", 23.00, 8,Category.CLOTHES);
...
//			Product product52 = new Product("Looper Hybrid Headcover", "Cover up your hybrids in quality and they'll keep producing quality shots for you. Protection comes from durable polyurethane, a soft green velour lining safeguards the club, and the 'X' and PING letters are sewn-on.", "https://pingmediastage.azureedge.net/mediastorage/mediastorage/ping-na/medialibrary/ecommerce/2023/looper%20collection%20(masters)/looper_hybridheadcover_708x708.jpg?sku=36659-01", 40.00, 15, Category.ACCESORIES);
			...
			OrderProduct orderProduct1 = new OrderProduct(1, 1400.00);
			order1.addOrderProduct(orderProduct1);
			product1.addOrderProduct(orderProduct1);

			OrderProduct orderProduct2 = new OrderProduct(1, 600.00);
